...
import type { IService, ServiceRegistration } from './service-manager';
...
export class ServiceManagerV2 {
   ...
   */
  registerService<T extends import('./service-manager').IService>(
    name: string,
    service: T,
   ...
   */
  getService<T extends import('./service-manager').IService>(name: string): T | undefined {
   ...
   */
  getAllServices(): Map<string, import('./service-manager').IService> {
    const servicesMap = new Map<string, import('./service-manager').IService>();
...
export const serviceManagerV2 = ServiceManagerV2.getInstance();

// Convenience functions for backward compatibility
export const getService = <T extends import('./service-manager').IService>(name: string): T | undefined => {
  return serviceManagerV2.getService<T>(name);
};

export const getServicesHealth = (): Record<string, any> => {
  return serviceManagerV2.getAllServicesHealth();
};

export const initializeServices = async (): Promise<void> => {
  return serviceManagerV2.initializeAllServices();
};