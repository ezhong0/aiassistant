...
export const ERROR_CODES = {
  ...
  SLACK_PERMISSION_DENIED: 'SLACK_PERMISSION_DENIED',
...
export const ERROR_CODE_TO_CATEGORY: Record<string, ErrorCodeCategory> = {
  ...
  [ERROR_CODES.SLACK_API_ERROR]: ERROR_CODE_CATEGORIES.EXTERNAL,
  [ERROR_CODES.SLACK_AUTH_FAILED]: ERROR_CODE_CATEGORIES.EXTERNAL,
  [ERROR_CODES.SLACK_RATE_LIMIT]: ERROR_CODE_CATEGORIES.EXTERNAL,
  [ERROR_CODES.SLACK_CHANNEL_NOT_FOUND]: ERROR_CODE_CATEGORIES.EXTERNAL,
  [ERROR_CODES.SLACK_PERMISSION_DENIED]: ERROR_CODE_CATEGORIES.EXTERNAL,
